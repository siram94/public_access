...
function updateImageDisplay() {
  document.getElementById("myText").value = document.getElementById("fileToLoad").value;
}
...
function fullscanTarget(data, localCounterin) {
  ...
  document.getElementById("recordedAudio").onended = function () { fullscanTargetdark(data, localCounterout) };
}
...
function fullscanTargetdark(data, localCounter) {
  ...
  document.getElementById("recordedAudio").onended = function () { fullscanTarget(data, localCounterin) };
}
...
function sendData(data) {
  ...
  imageStack[counter] = document.getElementById("fileToLoad").value.replace('C:\\fakepath\\', '');
...
function showUploads() {
  ...
  for (i=0;i<imageStack.length;i++){
    document.getElementById("close").innerHTML = document.getElementById("close").innerHTML +"<br>"+ imageStack[i]+"<br>";
  }
